...
- [Дополнительная литература](#additional-books)
- [Additional Learning](#additional-learning)
    - [Компилляторы](#compilers)
    - [Числа с плавающей точкой](#floating-point-numbers)
    - [Unicode](#unicode)
    - [Endianness](#endianness)
    - [Emacs and vi(m)](#emacs-and-vim)
    - [Инструменты командной строки Unix](#unix-command-line-tools)
